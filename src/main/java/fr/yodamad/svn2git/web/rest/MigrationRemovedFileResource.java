...
public class MigrationRemovedFileResource {
    ...
    public ResponseEntity<MigrationRemovedFile> createMigrationRemovedFile(@Valid @RequestBody MigrationRemovedFile migrationRemovedFile) throws URISyntaxException {
    ...
    public ResponseEntity<MigrationRemovedFile> updateMigrationRemovedFile(@Valid @RequestBody MigrationRemovedFile migrationRemovedFile) throws URISyntaxException {
    ...
    public ResponseEntity<List<MigrationRemovedFile>> getAllMigrationRemovedFiles(Pageable pageable) {
        log.debug("REST request to get a page of MigrationRemovedFiles");
        Page<MigrationRemovedFile> page = migrationRemovedFileService.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/migration-removed-files");
