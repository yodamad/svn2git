...
import { Svn2GitSharedLibsModule, Svn2GitSharedCommonModule } from './';
...
@NgModule({
    ...
    declarations: [JhiAddMappingModalComponent, JhiConfirmRetryModalComponent],
    ...
    exports: [Svn2GitSharedCommonModule],
